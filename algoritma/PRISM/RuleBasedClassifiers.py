            ...
            while instances:
                ...
                while perfect_rule == False and len(rule) < self.n_features+1:
                    ...
                    if optimal_selector_prec[2] > 0.0 and optimal_selector_prec[2] < 1.0:
                        ...
                        filtered_rows = X_train_[(X_train_[selector[0]] != selector[1])].index.values;
                        print(filtered_rows);
